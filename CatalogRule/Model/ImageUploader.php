...
namespace MMT\CatalogRule\Model;
...
class ImageUploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH = 'catalog_promo/tmp';

    /**
     * @var string
     */
    const IMAGE_PATH = 'catalog_promo';

    /**
     * @var string
     */
    const FILE_TMP_PATH = 'catalog_promo/tmp/images/file';

    /**
     * @var string
     */
    const FILE_PATH = 'catalog_promo/images/file';
    ...
    public function __construct(
        ...
        $this->setBaseTmpPath($baseTmpPath ? $baseTmpPath : self::IMAGE_TMP_PATH);
        $this->setBasePath($basePath ? $basePath : self::IMAGE_PATH);
    }
    ...
    public function moveFileFromTmp($name)
    {
        ...
        try {
            ...
            throw new LocalizedException(
                __($e->getMessage() . 'Something went wrong while saving the file(s).')
            );
        }
