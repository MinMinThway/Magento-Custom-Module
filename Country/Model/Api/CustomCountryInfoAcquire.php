...
namespace MMT\Country\Model\Api;

use Magento\Directory\Model\CountryInformationAcquirer;
use Magento\Framework\Exception\NoSuchEntityException;
use MMT\Country\Api\CustomCountryInfoAcquireInterface;
...
class CustomCountryInfoAcquire implements CustomCountryInfoAcquireInterface
{
    ...
    /**
     * @param \MMT\Country\Model\CustomCountryInfoFactory $countryInformationFactory
     * @param \MMT\Country\Model\CustomRegionInfoFactory $regionInformationFactory
     * @param \Magento\Directory\Helper\Data $directoryHelper
     * @param \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig
     * @param \Magento\Store\Model\StoreManagerInterface $storeManager
     */
    public function __construct(
        \MMT\Country\Model\CustomCountryInfoFactory $countryInformationFactory,
        \MMT\Country\Model\CustomRegionInfoFactory $regionInformationFactory,
