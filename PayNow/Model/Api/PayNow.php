...
namespace MMT\PayNow\Model\Api;

use Magento\Framework\Exception\AuthorizationException;
use Magento\Framework\Exception\NoSuchEntityException;
use Magento\Framework\Exception\RemoteServiceUnavailableException;
use Magento\Sales\Model\OrderFactory;
use MMT\PayNow\Api\PayNowInterface;
use MMT\PayNow\Model\KPayCredentialFactory;
use \Payment\Kbz\Helper\Data as Helper;
use Payment\Kbz\Helper\RSAUtil;

class PayNow implements PayNowInterface
{
    const PAYNOW_URL = 'https://pgateway-app.azurewebsites.net/api/applink';  //'https://paymentgateway.mitcloud.com/api/applink';
