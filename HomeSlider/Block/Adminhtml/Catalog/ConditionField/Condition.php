...
namespace MMT\HomeSlider\Block\Adminhtml\Catalog\ConditionField;
...
class Condition extends Generic implements TabInterface
{
    ...
    /**
     * @var \MMT\HomeSlider\Model\HomeSliderFactory
     */
    private $ruleFactory;
    ...
    private function getRuleFactory()
    {
        if ($this->ruleFactory === null) {
            $this->ruleFactory = ObjectManager::getInstance()->get('MMT\HomeSlider\Model\HomeSliderFactory');
        }
    ...
    /**
     * @param \MMT\HomeSlider\Api\Data\HomeSliderInterface $model
    ...
    protected function addTabToForm(
        ...
        $formName = 'mit_homeslider_homeslider_form'
    ) {
        if (!$model) {
