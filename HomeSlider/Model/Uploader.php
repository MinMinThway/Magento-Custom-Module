...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'homeslider/tmp/images/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'homeslider/images/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'homeslider/tmp/images/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'homeslider/images/file';
