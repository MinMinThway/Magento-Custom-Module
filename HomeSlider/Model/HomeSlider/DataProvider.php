...
namespace MMT\HomeSlider\Model\HomeSlider;
...
class DataProvider extends AbstractDataProvider
{
    ...
    public function getData()
    {
        ...
        foreach ($items as $model) {
            ...
            if ($temp['home_slider_image_mobile_app']) {
                unset($temp['home_slider_image_mobile_app']);
                $temp['home_slider_image_mobile_app'][0]['name'] = $data['home_slider_image_mobile_app'];
                $temp['home_slider_image_mobile_app'][0]['url'] = $this->getMediaUrl() . $data['home_slider_image_mobile_app'];
                $temp['home_slider_image_mobile_app'][0]['type'] = 'image/png';
                $temp['home_slider_image_mobile_app'][0]['size'] = '111';
            }
            if ($temp['banner_image']) {
                unset($temp['banner_image']);
                $temp['banner_image'][0]['name'] = $data['banner_image'];
                $temp['banner_image'][0]['url'] = $this->getMediaUrl() . $data['banner_image'];
                $temp['banner_image'][0]['type'] = 'image/png';
                $temp['banner_image'][0]['size'] = '111';
            }
