...
use MMT\Product\Api\Data\CustomProductManagementInterface;
...
class CustomProduct extends Product implements CustomProductManagementInterface
{
    ...
    {
        return $this->setData(self::CHOSEN_GIFT_PRODUCT_QTY, $qty);
    }
    ...
    {
        return $this->getData(self::CHOSEN_GIFT_PRODUCT_QTY) != null ? $this->getData(self::CHOSEN_GIFT_PRODUCT_QTY) : 0;
    }
}
